...
class CAiD_MoCo(nn.Module):
    ...
    def forward(self, im_q, im_k):
        ...
        # compute query features
        q, rec_output = self.encoder_q(im_q)  # queries: NxC
        q = nn.functional.normalize(q, dim=1)
